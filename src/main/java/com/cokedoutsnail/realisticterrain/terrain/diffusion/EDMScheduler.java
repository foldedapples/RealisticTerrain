...
/**
 * Port of EDMDPMSolverMultistepScheduler with Karras sigma schedule
 * and DPM-Solver++ second-order multistep update.
 *
 * <p>Adapted from com.github.xandergos.terraindiffusionmc.pipeline.EDMScheduler
 * Original copyright: Apache 2.0 (derived from dpm-solver and EDM)
 */
public final class EDMScheduler {
    ...
    private float[] prevModelOutput = null;
